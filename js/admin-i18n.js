...
export const adminTranslations = {
  fr: {
    ...
    badge_new: "NOUVEAU",
    flipbook_scraper_title: "📖 Scraper le Digital Flipbook Complet (Dernière Version)",
    flipbook_scraper_desc: "Laissez vide pour détecter et scraper automatiquement le tout dernier catalogue officiel Oriflame Tunisie (avec toutes ses pages, photos HD et pastilles d'achat), ou collez un lien spécifique.",
    btn_scrape_flipbook: "🚀 Scraper le Dernier Flipbook (Auto)",
    ...
    whatsapp_phone_title: "Numéro de Téléphone / WhatsApp de Réception des Commandes",
    whatsapp_phone_desc: "Entrez le numéro WhatsApp/Téléphone où vos clients enverront leurs messages de commande (ex: 55756629).",
    btn_save_whatsapp: "Enregistrer le Numéro WhatsApp",
  ...
  ar: {
    ...
    badge_new: "جديد",
    flipbook_scraper_title: "📖 سحب الكتالوج الرقمي الكامل (أحدث إصدار)",
    flipbook_scraper_desc: "اتركي الحقل فارغاً للكشف التلقائي وسحب أحدث كتالوج رسمي صادر من أوريفلام تونس (مع جميع الصفحات والصور عالية الدقة ونقاط الشراء)، أو الصقي رابطاً محدداً.",
    btn_scrape_flipbook: "🚀 سحب أحدث كتالوج (تلقائي)",
    ...
    whatsapp_phone_title: "رقم الهاتف / الواتساب لاستقبال الطلبات",
    whatsapp_phone_desc: "أدخلي رقم الواتساب/الهاتف الذي سيتواصل معك الزبائن من خلاله لتأكيد الطلب (مثال: 55756629).",
    btn_save_whatsapp: "حفظ رقم الواتساب",
  ...
  en: {
    ...
    badge_new: "NEW",
    flipbook_scraper_title: "📖 Scrape Full Digital Flipbook (Latest Version)",
    flipbook_scraper_desc: "Leave empty to automatically detect and scrape the latest official Oriflame Tunisia catalog (with all pages, HD images and interactive hotspot tags), or paste a specific link.",
    btn_scrape_flipbook: "🚀 Scrape Latest Flipbook (Auto)",
    ...
    whatsapp_phone_title: "WhatsApp / Phone Number for Order Messages",
    whatsapp_phone_desc: "Enter the Tunisian WhatsApp/Phone number where customers will send their order messages (e.g. 55756629).",
    btn_save_whatsapp: "Save WhatsApp Number",
